...
import com.cph.lib.core.ui.banner.BannerCreator;
...
public class MultipleRecyclerAdapter extends
    ...
    public static MultipleRecyclerAdapter create(DatatConverter converter){
    ...
    protected void convert(MultipleViewHolder holder, MultipleItemEntity entity) {
        ...
        switch (holder.getItemViewType()){
            ...
            case ItemType.BANNER:
                if(!mIsInitBanner){
                    bannerImages = entity.getField(MultipleFields.BANANERS);
