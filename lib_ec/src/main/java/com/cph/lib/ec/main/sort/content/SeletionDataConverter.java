 ...
 */
public class SeletionDataConverter  {
    ...
    final List<SectionBean> convert(String json) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 1; j < goodSize; j++) {
                ...
                final String url = contentItem.getString("goods_thumb");
                final String name = contentItem.getString("goods_name");

                final SectionContentItemEntity itemEntity = new SectionContentItemEntity();
                itemEntity.setmGoodsId(goodsId);
                itemEntity.setmGoodsName(name);
                itemEntity.setmGoodsThumb(url);
